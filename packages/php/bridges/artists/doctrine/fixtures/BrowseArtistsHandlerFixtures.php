...
class BrowseArtistsHandlerFixtures implements FixtureInterface
{
    ...
    private function addJohnHolt(ObjectManager $manager): void
    {
        ...
        NSA::setProperty($artist1, 'creationDate', new \DateTimeImmutable('2021-05-22 17:02:34'));
    ...
    private function addFreddyMcGreggor(ObjectManager $manager): void
    {
        ...
        NSA::setProperty($artist2, 'creationDate', new \DateTimeImmutable('2021-05-22 17:03:34'));
